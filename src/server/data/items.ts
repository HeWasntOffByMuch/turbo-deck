...
/**
 * The rarity tiers, in ascending order (spec 154). **Three, and on purpose.**
 *
 * Three is what the presentation ladder in `data/loot.ts` needs -- quiet,
 * delayed, longer -- and a fourth would be a tier with nothing to say. Spec 154
...
export interface ItemDefinition {
  ...
  /**
   * How loudly this announces itself when it drops (spec 154). Absent is
   ...
   * copies could differ in what they do, which needs affixes, which spec 154
