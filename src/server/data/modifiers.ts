 ...
 * exception (spec 256) and say so on their own rows: they move a threshold that
...
export interface TraitModifier {
  ...
  /**
   * Sums, **subtracted** from the follow-through's cancel threshold (spec 256).
   *
  ...
  /** Sums; subtracted from the cancel threshold **per Flow stack** (spec 256). */
