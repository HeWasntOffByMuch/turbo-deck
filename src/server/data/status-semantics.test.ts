...
describe('the tags are internally coherent (spec 233)', () => {
...
describe('the tags agree with the tables beside them (spec 233)', () => {
...
describe('what counts as an affliction (spec 233)', () => {
