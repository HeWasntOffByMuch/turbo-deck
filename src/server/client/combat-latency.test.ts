...
/**
 * Long enough to contain a dozen swings at the cadence spec 082 set (1.2s bare,
...
async function play(options: {
  ...
  // one that got much easier to hit when spec 082 made swings rarer.
...
describe('a swing, over a wire', () => {
  it('is drawn the instant it is asked for, and never late, on a free connection', async () => {
    ...
    // spec 082's 1.2s delay one press per run does. At most one, though: a
