/**
 * The follow-through you may leave (spec 258).
 *
...
describe('the cancel threshold (spec 258)', () => {
...
describe('what the cancel point must never touch (spec 258)', () => {
...
describe('a follow-through in the real tick (spec 258)', () => {
  ...
  it('leaves Perfect Exit alone, because it reads the wind-up', () => {
    // Audited against the new model (spec 258) rather than redesigned: its
