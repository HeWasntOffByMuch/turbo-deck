...
export interface AttackTimingBase {
   ...
   * becomes legal (spec 253). 0.7 is "seven tenths of it".
   *
 ...
 * whenever you like", which is the behaviour spec 253 exists to replace, and it
...
export interface AttackTiming {
   ...
   * legal (spec 253). 0 when there is no follow-through to leave.
   *
