...
export interface AttackTimingBase {
   ...
   * becomes legal (spec 256). 0.7 is "seven tenths of it".
   *
 ...
 * whenever you like", which is the behaviour spec 256 exists to replace, and it
...
export interface AttackTiming {
   ...
   * legal (spec 256). 0 when there is no follow-through to leave.
   *
