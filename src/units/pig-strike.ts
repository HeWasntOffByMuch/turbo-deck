...
const KEYS: readonly PoseKey[] = [
  ...
  },
  {
    ...
    turns: {
      ...
      rightArm: { lateral: -44.5, forward: 2.2, up: 7.4 },
      rightForeArm: { flex: 55.8 },
      rightHand: { lateral: 26.7, forward: 26.9, up: -61.3 },
  ...
  },
  {
    ...
    turns: {
      ...
      rightArm: { lateral: -83, forward: 26.6, up: -36.6 },
      rightForeArm: { flex: 65.7 },
      rightHand: { lateral: 27.7, forward: 29.1, up: -69.5 },
  ...
  },
  {
    ...
    turns: {
      ...
      rightArm: { lateral: -92, forward: 33.1, up: -43.1 },
      rightForeArm: { flex: 68.1 },
      rightHand: { lateral: 27.5, forward: 29, up: -71 },
  ...
  },
  {
    ...
    turns: {
      ...
      rightArm: { lateral: 6.8, forward: -13.9, up: 34.2 },
      rightForeArm: { flex: 9.6 },
      rightHand: { lateral: 24.9, forward: 20.3, up: -43.4 },
  ...
  },
  {
    ...
    turns: {
      ...
      rightArm: { lateral: 3.1, forward: -26.3, up: 60 },
      rightForeArm: { flex: 12.6 },
      rightHand: { lateral: 31.6, forward: 30.1, up: -50.1 },
