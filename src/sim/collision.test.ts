 ...
 *
 * Its own rectangle since spec 219 removed the hand-authored layout this used
...
describe('a world carries only the colliders it was given (spec 219)', () => {
...
describe('hitbox geometry', () => {
  ...
  it('reports a barricade as blocking inside it and clear out in the open', () => {
    // The world is named rather than defaulted since spec 219: the default
