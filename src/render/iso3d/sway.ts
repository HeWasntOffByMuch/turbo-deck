...
// The normal that goes with the bend above (spec 087).
//
...
export function applySway(
  ...
  trail: SwayLag = {},
  /**
   * Rotate the vertex normal along with the vertex (spec 087). Off by default,
 ...
 * only when asked for (spec 087, step 2).
 *
