...
export interface UiScreensOptions {
  ...
  /**
   * A carry let go of over the world (spec 168): put it on the ground.
   *
...
export class UiScreens {
  ...
  handlePointer(phase: 'down' | 'up' | 'move', pos: Point, button: number, mods: Modifiers): boolean {
    ...
    // A press on the world with something in hand puts it down (spec 168), and
  ...
  /**
   * Put a carried stack down, if the press landed on the world (spec 168).
   *
