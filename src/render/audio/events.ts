...
export const SOUND_EVENTS = [
  ...
  // ---------------------------------------------------------------- combat --
  {
    ...
    section: 'Swings',
    placement: 'world',
    note: 'A wind-up by a body whose weapon is unknown -- every monster, and every other player. Only your own equipment is on the wire.',
  },
  {
    ...
    section: 'Swings',
    placement: 'world',
    note: 'The same, for a heavy blow. Weapon unknown; your own goes to its weapon\'s row.',
  },
  {
    id: 'combat.swing.sword',
    label: 'Sword swing',
    bus: 'combat',
    section: 'Swings',
    placement: 'world',
    note: 'A blade winds up. Your own only -- see the note on `combat.swing.light`.',
  },
  {
    id: 'combat.swing.maul',
    label: 'Maul swing',
    bus: 'combat',
    section: 'Swings',
    placement: 'world',
    note: 'A heavy head winds up. Your own only.',
  },
  {
    id: 'combat.swing.staff',
    label: 'Staff swing',
    bus: 'combat',
    section: 'Swings',
    placement: 'world',
    note: 'A shaft winds up. Your own only.',
  },
  {
    id: 'combat.bow.draw',
    label: 'Bow drawn',
