...
src/render/      the client: a tab shell over the play view, the two tuning
                 ...
                 **defers** rather than picking a side, so a misspelling costs
                 ...
                 rather than about the device (spec 252), and it exists because
