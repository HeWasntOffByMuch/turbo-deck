# 209 — Growing without rewriting

## Problem

Spec 204 made a grow **write** only the regions it touched — 223 of 224
...
- **The editor's save.** It posts a whole document — it holds the whole map — so
  ...
  change, and behind spec 207's larger finding that the editor's *open* is 30.7 s
  at 4× anyway.
