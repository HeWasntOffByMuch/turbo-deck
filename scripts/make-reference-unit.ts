...
function main(): void {
  ...
  write(join(outDir, 'biped-dev.skeleton.json'), json(unit.skeleton));
  ...
  const clipLib: ClipLib = {
    ...
    formatVersion: 1,
    id: 'biped-dev.core',
    skeletonRef: 'biped-dev.skeleton.json',
    clips: unit.clips,
  };
  write(join(outDir, 'biped-dev.core.cliplib.json'), json(clipLib));
  ...
  const unitDef: UnitDef = {
    ...
    skeletonRef: 'biped-dev.skeleton.json',
    clipLibRef: 'biped-dev.core.cliplib.json',
    provenance: {
