...
console.log('  survival separates them, with four Constitution-free controls for scale.\n');
console.log(
...
const CONTROLS = new Set(['pure.strength', 'spend.specialized', 'spend.strLoop', 'pair.strPer']);
